...
<script type="text/javascript" src="../res/bootstrap-dialog/js/bootstrap-dialog.min.js"></script>

<script type="text/javascript" src="../res/js/social-market.js" ></script> 
<script type="text/javascript" src="../res/spinner/jquery.spinner.min.js"></script>	
<script type="text/javascript" src="../res/js/spinner.js"></script>	
...
<script type="text/javascript" src="../res/js/moment/moment.js"></script>
