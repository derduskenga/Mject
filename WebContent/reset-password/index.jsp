		...
		if(token.equals("") || token==null || id.equals("") || id==null){
			...
			try{
					...
					if(rs.next()){
						...
						if(diff<0.0){
							message="Your Password set period has expired. Please contact the Super administrator for assistance";
						}else if(status == true){
							message="You have already set your password using this link.";
						}
					}else{
