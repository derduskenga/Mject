	...
	<div class="container-fluid">
		...
		<header class="row">
			...
			<div class="col-md-4 col-md-offset-7 text-right">				
				<span> Already have an account? <a href="../signup"><button type="button" class="btn btn-danger"> SIGN IN</button> </a></span>
			</div>
		</header>		
			...
			<div id="content_right" class="col-lg-6 col-lg-offset-3">
				<div class="row">
					<div class="col-md-11 col-md-offset-1 text-center" id="password-reset-panel-">	
						...
						<span class="error_span">Oooh! Sorry! <br/>We could not find the page you are trying to view.</span>
