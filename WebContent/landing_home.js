	...
	if(data['status']=='OK'){
	 ...
	 // var cArr = [];
	  ...
	  for(var i = 0;i<arr.length;i++){
	      ...
	      var request_owner_pic_path = "../profilePic/" + arr[i]["post_owner_pic_path"];
	      ...
	      $('#comment-and-post').prepend("<div id='donation-post-" + donation_request_id + "' class='post'>" +
				...
				"<button id='recommend-action_link-" + donation_request_id  + "-" + request_owner_entity_id +"'class='link' title='"+ recommendation_title +"'>" + recommend_button_label + "</button> <span id = 'badge-" + donation_request_id +"-" + request_owner_entity_id + "' class='badge badge-important'>" + recommendation_count + "</span>" +
...
//     =============================end donation validation======================================
    ...
    //..........................................donation-options-next button click action.....start
	 ...
	 $('#donate-footer').on('click','.next-for-options',function(){
		...
		if($('#harambesa-option').is(':checked')){ 
			...
			$('#pay-by-harambesa-option').html("<div class='alert alert-info'>" +
    ...
    //..........................................donation-options-next button click action.....end
	 ...
	 $('#donate-footer').on('click','.complete-donation-harambesa-option',function(){
		...
		$.post("../mapping/mapping.jsp", {tag:"finalise_donation",donor:generateValueArray()[0],donee:generateValueArray()[1],
						  currency:generateValueArray()[2],amount:generateValueArray()[3]}, function(data){
